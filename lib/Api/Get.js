...
exports.channelMessages = async (id, number, token) => {
  const messages = await fetch(
    url + `/channels/${id}/messages?limit=${String(number)}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
exports.message = async (messageid, channelid, token) => {
  const message = (
    await fetch(url + `/channels/${channelid}/messages/${messageid}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bot ${token}`,
...
exports.user = async (id, token) => {
  let user = await fetch(url + `users/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bot ${token}`,
...
exports.member = async (guildid, memberid, token) => {
  const member = (
    await fetch(url + `guilds/${guildid}/members/${memberid}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bot ${token}`,
...
exports.roles = async (guildid, token) => {
  const role = (
    await fetch(url + `guilds/${guildid}/roles`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bot ${token}`,
...
exports.invites = {
  get: async (code, token) => {
    const msg = (
      await fetch(
        url + `invites/${code}?with_counts=true&?with_expiration=true`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
