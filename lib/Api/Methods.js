...
exports.react = async (messageid, channelid, emoji, token) => {
...
exports.role = {
    delete: async (guildid, roleid, token) => {
        const role = (await fetch(url + `guilds/${guildid}/roles/${roleid}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bot ${token}`
...
exports.channel = {
    delete: async (channelid, token) => {
        const msg = (await fetch(url + `/channels/${channelid}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bot ${token}`
...
exports.invites = {
    delete: async () => {
        const invite = (await fetch(url + `invites/${this.code}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
