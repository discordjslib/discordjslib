...
const GuildInvite = require("./Classes/Guild/Invite");
...
module.exports = class Discord {
  ...
  Stage(channel, client) {
    return new Stage(channel, client);
  }
  Store(channel, client) {
    return new Store(channel, client);
  }
  News(channel, client) {
    return new News(channel, client);
  }
};
